  ...
  return (
    ...
    >
      <Grid item xs={12} sm={12} md={5} component="section">
        <Title text={"Vision"} textAlign={"start"} />
        ...
        <Paragraph
          text={
            " To be a pioneering force in shaping a dynamic culture of innovation and\
                    entrepreneurship, where creativity thrives, and groundbreaking solutions emerge to\
                    praddress global challenges."
          }
          maxWidth={"75%"}
          mx={0}
          textAlign={"start"}
